defmodule ExCoinglass.Options.OpenInterest do
  alias ExCoinglass.JsonResponse

  @type symbol :: String.t()
  @type api_key :: String.t()
  @type options_open_interest :: ExCoinglass.OptionsOpenInterest.t()
  ...
  defp parse_response({:ok, %JsonResponse{success: true, data: open_interest}}) do
    open_interest
    |> Enum.map(&Mapail.map_to_struct(&1, ExCoinglass.OptionsOpenInterest, transformations: [:snake_case]))
    |> Enum.reduce(
      {:ok, []},
      fn
